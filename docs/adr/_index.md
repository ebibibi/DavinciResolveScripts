...
- [ADR-010: Cut silence at 1 percent with 0.3-second margins](010-cut-silence-at-1-percent-with-0.3-second-margins.md) — Match the retune the stable editor already shipped, and pin both routes to it with a test. (accepted, 2026-08-02)

...
- [ADR-009: Detect the dual source shape inside the stable route](009-detect-the-dual-source-shape-inside-the-stable-route.md) — A folder holding one `.mkv` and one `.mp4` selects the slides plus camera timeline; anything else edits exactly as before. (accepted, 2026-08-02)

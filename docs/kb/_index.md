...
- [EBI title: No frame available for MediaOut1](ebi-title-mediaout-no-frame.md) — Port-reference correction and backup-first repair; application verification pending.
